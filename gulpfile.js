...
// wiredep task to categoryion
gulp.task('wiredep:prod', function () {
  return gulp.src('config/assets/categoryion.js')
    .pipe(wiredep({
      ignorePath: '../../',
      fileTypes: {
        js: {
...
// Lint project files and minify them into two categoryion files.
...
// Run the project in categoryion mode
