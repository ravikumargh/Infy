...
Infy up to date and always improving! There are a few guidelines that we need
contributors to follow to keep the project consistent, as well as allow us to keep
maintaining Infy in a reasonable amount of time.
...
* Submit a pull request from your topic branch to the master branch on the Infy repository.
