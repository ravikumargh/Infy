...
describe('Configuration Tests:', function () {
  ...
  describe('Testing default seedDB', function () {
    ...
    it('should seed ONLY the admin user account when NODE_ENV is set to "categoryion"', function(done) {

      // Save original value
      var nodeEnv = process.env.NODE_ENV;
      // Set node env ro categoryion environment
      process.env.NODE_ENV = 'categoryion';
    ...
    it('should ONLY seed admin user account when NODE_ENV is set to "categoryion" with custom admin', function(done) {
    ...
    it('should NOT seed admin user account if it already exists when NODE_ENV is set to "categoryion"', function(done) {
  ...
  describe('Testing Session Secret Configuration', function () {
    it('should warn if using default session secret when running in categoryion', function (done) {
      var conf = { sessionSecret: 'INFY' };
      // set env to categoryion for this test
      process.env.NODE_ENV = 'categoryion';
    ...
    it('should accept non-default session secret when running in categoryion', function () {
  ...
  describe('Testing exposing environment as a variable to layout', function () {
    ...
    ['development', 'categoryion', 'test'].forEach(function(env) {
